...
//    }
//}
//extension Range where Bound == Index {
//    var nsRange:NSRange?{
//        return NSRange.init(location:self.lowerBound.encodedOffset,
...
//    let termsRange = self.lblConfirmText.text?.ranges(of:"اشعار الخصوصية").last
//    // comment for now
//    let a = NSRange.init(location:termsRange!.lowerBound.encodedOffset, length:termsRange!.lowerBound.encodedOffset-termsRange!.upperBound.encodedOffset);
//    if gesture.didTapAttributedTextInLabel(label:self.lblConfirmText,inRange:a) {
