...
//  SwiftUtility
//
//  Created by SalahMohamed on 19/03/2024.
...
public class DiskStatus {
    ...
    public class func GBFormatterDouble(_ bytes: Int64) -> Double? {
        return DiskStatus.GBFormatter(bytes).bs_replace(target:",", withString:"").bs_double
    }
